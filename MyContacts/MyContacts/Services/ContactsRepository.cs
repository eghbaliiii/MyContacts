...
namespace MyContacts
{
    class ContactsRepository : IContanctsRepository
    {
        ...
        private string connectionString = "Data Source = DESKTOP-B3QU0B3\\EMSSQLSERVER;Initial Catalog=Contact_DB;Integrated Security=true;TrustServerCertificate=true";
